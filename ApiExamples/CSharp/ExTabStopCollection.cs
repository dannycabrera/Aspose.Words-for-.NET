...
namespace ApiExamples
{
    ...
    public class ExTabStopCollection : ApiExampleBase
    {
        ...
        public void GetIndexByPositionEx()
        {
            ...
            Console.WriteLine(paragraph.ParagraphFormat.TabStops.GetIndexByPosition(ConvertUtil.MillimeterToPoint(30)));
                // 0
            Console.WriteLine(paragraph.ParagraphFormat.TabStops.GetIndexByPosition(ConvertUtil.MillimeterToPoint(60)));
                // -1
            //ExEnd
        }
    }
